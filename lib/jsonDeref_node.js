...
function deref(json, options) {
  ...
  return ((typeof json === 'undefined' ? 'undefined' : _typeof(json)) !== 'object' ? getJsonResource(json, {}) : Promise.resolve(Object.assign(jsonCache, { raw: json, parsed: Array.isArray(json) ? [] : {} }))).then(function (_ref) {
    var raw = _ref.raw;
    var parsed = _ref.parsed;

    Object.assign(jsonCache, options.jsonResources, options.cache ? resourceCache : {});
