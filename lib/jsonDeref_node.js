                ...
                nextProp();
                  ...
                  nextProp();
                    ...
                    (function () {
                      ...
                      var _splitRef = splitRef($ref);

                      var _splitRef2 = _slicedToArray(_splitRef, 2);

                      var url = _splitRef2[0];
                      var _splitRef2$ = _splitRef2[1];
                      var pointer = _splitRef2$ === undefined ? '' : _splitRef2$;
